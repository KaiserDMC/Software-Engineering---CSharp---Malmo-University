...
{
    //Class used for filling in the Email information. All methods here are handling various tasks needed for the Email
    //This class serves more as a template for how the different email should be read and stored.
    //All methods here tackle tasks for single email only.
    //Class was given as template by the teacher in Assignmnet 5.
    public class Email
    {
        //private email
