...
namespace Assignment5.ContactFiles
{
    ...
    public class Contact
    {
        ...
        private Address m_address; //Address of the contact; uses Address class
        ...
        public Contact(string firstName, string lastName, Address adr, Phone tel, Email mail) //2nd Constructor with all parameters
        {
        ...
        public Address AddressData //Address properties
        {
